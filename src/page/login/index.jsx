        ...
        return (
            <div className='login'>
                ...
                <div className='w_90 pl_10 mt20'>
                    {/* 用户名: <input type="text" value={this.state.name} onChange={this.nameChange}/> */}
                    <Input className='w_100' icon='user secret' value={this.state.name}  onChange={this.nameChange} iconPosition='left' placeholder='账号' />
                </div>
                <div className='w_90 pl_10 mt20'>
                    {/* 密码: <input type="text" value={this.state.pas} onChange={this.pasChange}/> */}
                    <Input className='w_100' icon='sign-out' iconPosition='left'  value={this.state.pas} onChange={this.pasChange} placeholder='密码' />
                </div>
